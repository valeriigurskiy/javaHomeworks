...
import homework5.ComputerTask.Computer;
...
//        year > 2010
//        List<Computer> collect = computers.stream().filter(computer -> computer.getYear() > 2010).collect(Collectors.toList());
//        System.out.println(collect);

//        year > 2010 & disk country china
//        List<Computer> collect = computers.stream().filter(computer -> computer.getYear() > 2010 && computer.hardDisk.getHdCountry() == ManufacturerCountry.China).collect(Collectors.toList());
//        System.out.println(collect);
...
//        disk memory > 500
//        List<Computer> collect = computers.stream().filter(computer -> computer.hardDisk.getDiskMemory() > 500).collect(Collectors.toList());
//        System.out.println(collect);

//        disk memory > 500 & cpu i7
//        List<Computer> collect = computers.stream().filter(computer -> computer.hardDisk.getDiskMemory() > 500 && computer.cpu.getType().equals("i7")).collect(Collectors.toList());
//        System.out.println(collect);

//        disk memory > 500 & cpu i7 sort by price
//        List<Computer> collect = computers.stream().filter(computer -> computer.hardDisk.getDiskMemory() > 500 && computer.cpu.getType().equals("i7")).sorted((pc1, pc2) -> pc1.price - pc2.price).collect(Collectors.toList());
//        System.out.println(collect);
